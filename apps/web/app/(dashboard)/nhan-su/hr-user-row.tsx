...
export function HrUserRow({ user }: { user: any }) {
  ...
  return (
    <>
      <TableRow 
        className="cursor-pointer hover:bg-slate-50 transition-colors whitespace-nowrap"
        onClick={(e) => {
      ...
      <Dialog open={openView} onOpenChange={setOpenView}>
        <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
          ...
          <div className="mt-6 space-y-4">
            <div className="flex items-center gap-3 p-3 bg-[#1a56db] rounded-lg border border-transparent shadow-sm">
              <Building className="h-5 w-5 text-white/90" />
              <div>
                <div className="text-xs text-blue-100 uppercase font-semibold">Phòng ban</div>
                <div className="text-white font-medium">{user.department || 'Chưa cập nhật'}</div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-[#1a56db] rounded-lg border border-transparent shadow-sm">
              <Briefcase className="h-5 w-5 text-white/90" />
              <div>
                <div className="text-xs text-blue-100 uppercase font-semibold">Chức vụ</div>
                <div className="text-white font-medium">{user.role || 'Chưa cập nhật'}</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-3 bg-[#1a56db] rounded-lg border border-transparent shadow-sm">
                ...
                <div className="overflow-hidden">
                  <div className="text-xs text-blue-100 uppercase font-semibold">Số điện thoại</div>
                  <div className="text-white font-medium truncate">{user.phone || 'Chưa cập nhật'}</div>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-[#1a56db] rounded-lg border border-transparent shadow-sm">
                <Mail className="h-5 w-5 text-white/90" />
                <div className="overflow-hidden">
                  <div className="text-xs text-blue-100 uppercase font-semibold">Email</div>
                  <div className="text-white font-medium truncate">{user.email || 'Chưa cập nhật'}</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-[#1a56db] rounded-lg border border-transparent shadow-sm">
              ...
              <div>
                <div className="text-xs text-blue-100 uppercase font-semibold">Địa chỉ</div>
                <div className="text-white font-medium">{user.address || 'Chưa cập nhật'}</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-3 bg-[#1a56db] rounded-lg border border-transparent shadow-sm">
                ...
                <div className="overflow-hidden">
                  <div className="text-xs text-blue-100 uppercase font-semibold">CCCD/CMND</div>
                  <div className="text-white font-medium truncate">{user.cccd || 'Chưa cập nhật'}</div>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-[#1a56db] rounded-lg border border-transparent shadow-sm">
                <Map className="h-5 w-5 text-white/90" />
                <div className="overflow-hidden">
                  <div className="text-xs text-blue-100 uppercase font-semibold">Quê quán</div>
                  <div className="text-white font-medium truncate">{user.hometown || 'Chưa cập nhật'}</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-3 bg-[#1a56db] rounded-lg border border-transparent shadow-sm">
                ...
                <div className="overflow-hidden">
                  <div className="text-xs text-blue-100 uppercase font-semibold">Số BHXH</div>
                  <div className="text-white font-medium truncate">{user.social_insurance_number || 'Chưa cập nhật'}</div>
                </div>
              </div>
              <div className="flex items-center gap-3 p-3 bg-[#1a56db] rounded-lg border border-transparent shadow-sm">
                <Heart className="h-5 w-5 text-white/90" />
                <div className="overflow-hidden">
                  <div className="text-xs text-blue-100 uppercase font-semibold">Số thẻ BHYT</div>
                  <div className="text-white font-medium truncate">{user.health_insurance_number || 'Chưa cập nhật'}</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-[#1a56db] rounded-lg border border-transparent shadow-sm">
              ...
              <div>
                <div className="text-xs text-blue-100 uppercase font-semibold">Ngày gia nhập</div>
                <div className="text-white font-medium">{joinDate}</div>
              </div>
            </div>
          </div>
        </DialogContent>
