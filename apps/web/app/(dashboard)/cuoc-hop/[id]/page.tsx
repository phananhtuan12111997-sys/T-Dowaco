  ...
  return (
    <div className="space-y-4 max-w-3xl mx-auto">
      <div className="flex items-center gap-2 text-sm text-slate-500 mb-1">
        <Link href="/cuoc-hop" className="hover:text-[#1a56db] transition-colors">LKWA</Link>
        <span>→</span>
        <Link href="/cuoc-hop" className="hover:text-[#1a56db]">Quản lý lịch họp</Link>
        <span>→</span>
        ...
        <div className="p-4 space-y-6">
          ...
          <div className="pt-4 flex justify-end">
            <Button variant="outline" asChild>
              <Link href="/cuoc-hop">Trở lại danh sách</Link>
            </Button>
          </div>
        </div>
      </div>
